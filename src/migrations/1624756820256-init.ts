...
export class init1624756820256 implements MigrationInterface {
    name = 'init1624756820256'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "public"."participants" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "type" integer NOT NULL, "userId" uuid NOT NULL, "conversationId" uuid NOT NULL, CONSTRAINT "PK_f0bfd55eb4f4b6738ee5605a048" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "public"."messages" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "message" character varying(255) NOT NULL, "messageType" integer NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP WITH TIME ZONE DEFAULT now(), "userId" uuid NOT NULL, "conversationId" uuid NOT NULL, CONSTRAINT "PK_cdce20d67a21ea39507f1df8eef" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "public"."conversations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "title" character varying(40) NOT NULL, "deletedAt" TIMESTAMP WITH TIME ZONE DEFAULT now(), "userId" uuid NOT NULL, CONSTRAINT "PK_e005f2014a3e0ec71e37731695c" PRIMARY KEY ("id"))`);
